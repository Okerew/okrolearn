from okrolearn.src.okrolearn.okrolearn import BatchNormLayer, L3RegularizationLayer, Tensor, np
...
def test_batchnorm_l3_layer():
    ...
    # Initialize BatchNormLayer and L3RegularizationLayer
    batch_norm_layer = BatchNormLayer(num_features=10)
    l3_layer = L3RegularizationLayer(layer=batch_norm_layer, lambda_=0.01)

    # Forward pass
    outputs = l3_layer.forward(inputs)
    ...
    # Backward pass
    grads = l3_layer.backward(dL_dout, lr)

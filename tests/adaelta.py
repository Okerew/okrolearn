...
from okrolearn.optimizers import AdadeltaOptimizer
...
network.train(inputs, targets, epochs=100, lr=0.01, optimizer=optimizer, batch_size=10, loss_function=loss_function)
